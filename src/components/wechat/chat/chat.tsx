                ...
                <div className={styles.body} ref={(chatBody) => this.chatBody = chatBody}>
                    {this.props.messages.map((msg: message, index: number) => {
                        ...
                        if (msg.isText) {
                            ...
                            return <Text mine={msg.mine} content={msg.content} avatarURL={msg.avatarURL} key={index}/>;
                        } else if (msg.isImage) {
                            if (!msg.imagePath) {
                            ...
                            return <Image mine={msg.mine} imagePath={msg.imagePath} avatarURL={msg.avatarURL} key={index}/>
                        } else if (msg.isDate) {
                            return <DateTime date={msg.date} key={index}/>
                        } else if (msg.isVoice) {
                            return <Voice vLength={msg.voiceLength} mine={msg.mine} avatarURL={msg.avatarURL} key={index}/>
                        }
                        return <Text mine={true} content={"Nothing"} key={index}/>
                    })}
                </div>
